...
UUID = os.environ.get('UUID', '2e79f0d4-dc91-4ea2-a6de-062fde0e8cb0') # 节点和哪吒v1使用的UUID，默认固定值，建议自行生成一个唯一的UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.yjj.gv.uy:443') # 哪吒面板域名,v1格式: nezha.xxx.com:8008  v0格式：nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')     # 哪吒v0的agnet端口，v1请留空
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'nnA7fTeiEZhiHlp6OiZNs9UzsXUeCuuO')       # 哪吒v1的NZ_CLIENT_SECRET的值，v0请的agent密钥
